...
//this is the student class very important class
class Student{
	char reg[10];
	char password[20];
public:
...
void set_task(int i){
		task_no = i;
		cout<<"Enter The Details Of Task : ";
		fflush(stdin);
		gets(task);
...
file.close();
cout<<"\n Your New Account Created Successfully.......(PRESS ENTER TO CONTINUE)\n";
getch();
faculty_menu();
}
void student_new(){
...
file.close();
if(flag==1){
cout<<"NO record found..(PRESS ENTER TO CONTINUE)\n";
getch();
faculty_menu();
}
}
...
file.close();
if(flag==1){
cout<<"\nNo record found....(PRESS ENTER TO CONTINUE)\n";
getch();
student_menu();}	
}
void faculty_signin_menu(){
...
int choice;
	cout<<"~~~~~~~~~~~~~ Select ~~~~~~~~~~~~\n";
	cout<<"1.Allot Assignment\n";
	cout<<"2.Update Assignment\n";
	cout<<"3.Delete Assignment\n";
	cout<<"4.Check submission\n";
	cout<<"5.Announce Topper\n";
	cout<<"6.Show complete result of student\n";
	cout<<"7.Give  marks to student\n";
	cout<<"8.Go back\n";
	cout<<"9.Exit";
	cout<<"\n\nEnter your choice : ";
	cin>>choice;
switch(choice){
	case 1 :
	faculty_create_task();break;
	case 2 : 
	faculty_update_task();break;
	case 3 : 
	faculty_delete_task();break;
	case 4 : 
	faculty_check_submission();break;
	case 5 : 
	faculty_announce_topper();break;
	case 6 :
	faculty_show_complete_result();break;
	case 7 : 
	faculty_submit_marks();break;
	case 8 : 
	faculty_menu();break;
	case 9 : 
	exit(0);break;
...
if(flag1==0){
	...
	cout<<"\n Generally Task deleted successfully.(PRESS ENTER TO CONTINUE)\n";
	getch();}
else if(flag1==1){
	Submit s;
...
string s2="temp";
	...
	getch();}
if(flag1==1 && flag2==1){
cout<<"No such record found.SORRY!!!!.....(PRESS ENTER TO CONTINUE)\n";
getch();}
faculty_signin_menu();
}
void faculty_update_task(){
...
if(flag2==0){	string s2="temp";
	...
	remove(reg.c_str());
	rename(s2.c_str(),reg.c_str());
	cout<<"Task number " <<task_no <<" Updated the account "<<reg<<" Successfully. (PRESS ENTER To continue)\n";
	getch();}
if(flag1==1 && flag2==1){
...
void faculty_check_submission(){
	...
	cout<<"====menu====\n";
	cout<<"1.Show whole list submission.\n";
	cout<<"2.Show Top five submission.\n";
	cout<<"3.Show Last five Submission.\n";
	cout<<"4.Go back.\n";
	cout<<"\n\n Enter your choice : ";
	cin>>choice;
	if(!file){
...
if(ch=='y'|| ch=='Y'){
   	...
   	cout<<"Marks submitted sucessfully. (PRESS ENTER KEY To continue)\n";
   	getch();
   }
faculty_signin_menu();
}
...
void faculty_submit_marks(){
	...
	Result r;
   	...
   	file.write((char*)&r,sizeof(r));
   	int option;
   	cout<<"Marks submitted sucessfully. Add more press 1 otherwise any key : ";
   	cin>>option;
   	if(option==1)
   	{
...
int choice;
	...
	switch(choice){
	case 1 :
	student_view_assignment(reg);break;
	case 2 : 
	student_submit_assignment(reg);break;
	case 3 : 
	student_view_result(reg);break;
	case 4 : 
	student_menu();break;
	case 5 : 
	exit(0);break;
	default : 
	cout<<"Wrong choice Entered By U ..";
...
if(choice==4){student_signin_menu(reg);}
int choice2;
cout<<"=======================================================================\n\n";
...
switch(choice){
	...
	case 3 : 
	exit(0);break;
default : cout<<"Wrong choice Entered..(PRESS ENTER TO CONTINUE)\n";
getch();
menu();}
}
int main(){
